...
assert true == true, "Background jobs available"
...
assert sum(nums) == 55, "sum works"
assert len(nums) == 10, "len works"
...
print("JSON: " + json_str)
assert json_str != nil, "json_stringify works"

# Test 10: Advanced data structures
print("\n--- Test 10: Advanced Collections ---")
var pq = PriorityQueue()
print("PriorityQueue available")
assert type(pq) == "object", "PriorityQueue works"

var dq = deque()
print("deque available")
assert type(dq) == "object", "deque works"
