...
<img src="https://img.shields.io/badge/version-1.5.4.4-blue.svg" alt="Version">
...
**v1.5.4.4** includes REPL Medium Features (.bg, .jobs, .plot, .async, background tasks, matplotlib). Previous phases (v1.5.2a, v1.5.2b, v1.5.3a, v1.5.3b) are partially done and need further enhancement.
