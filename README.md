...
| v1.5.20 | Polish (OpenGL restored, data structures verified, version bump) |
| v1.5.21 | Emergency Fixes (for-in loop in VM fixed) - Current |
| v1.5.22 | Final Audit & Verification |
