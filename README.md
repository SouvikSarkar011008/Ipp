...
<img src="https://img.shields.io/badge/version-1.5.5.0-blue.svg" alt="Version">
...
**v1.5.5.0** includes 3D Math Basics (vec4, mat4, matrix operations). Previous phases (v1.5.2a, v1.5.2b, v1.5.3a, v1.5.3b) are partially done and need further enhancement.
